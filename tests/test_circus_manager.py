...
async def circus_manager(mock_config_handler, mock_process_watcher):
    ...
    with patch(
        ...
        "src.circus_manager.manager.ProcessWatcher", return_value=mock_process_watcher
    ):
...
class TestSystemStatus:
    ...
    async def test_get_system_status(self, circus_manager, mock_circus_client):
        ...
        with patch(
            ...
            "src.circus_manager.manager.get_system_info", return_value={"cpu": "x86_64"}
        ):
            await circus_manager.initialize()
...
class TestPerformanceStats:
    ...
    async def test_performance_stats_error_tracking(
        self, circus_manager, mock_circus_client
    ):
