...
class ProcessWatcher:
    ...
    def add_process(self, process_name: str, initial_info: Optional[Dict[str, Any]] = None) -> None:
        """
    ...
    def update_process_info(self, process_name: str, **kwargs) -> None:
        ...
        for key, value in kwargs.items():
            if key not in ['pid', 'status', 'cpu_percent', 'memory_percent', 'started_at']:
    ...
    def _notify_callbacks(self, process_name: str, process_info: ProcessInfo) -> None:
        ...
        for callback in self._callbacks:
            try:
                ...
                logger.error(f"Error in process watcher callback {callback.__name__}: {str(e)}")
