...
class StreamManager:
    ...
    async def register_process(
        self, process_name: str, process_config: Optional[Dict[str, Any]] = None
    ) -> None:
        """
        ...
        self._output_buffers[process_name] = deque(
            maxlen=1000
        )  # Keep last 1000 output lines
    ...
    def add_stream_callback(
        self, process_name: str, callback: Callable[[str, str, Dict[str, Any]], None]
    ) -> None:
        """
    ...
    async def _notify_callbacks(
        self, process_name: str, event_type: str, data: Dict[str, Any]
    ) -> None:
        """
        ...
        if process_name:
            ...
            return {
                ...
                "active_processes": sum(
                    1 for active in self._active_streams.values() if active
                ),
            }
