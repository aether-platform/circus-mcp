...
class ProcessControlRequest(BaseModel):
    ...
    action: str = Field(
        ..., description="Action to perform (start, stop, restart, reload)"
    )
...
class GetStatusRequest(BaseModel):
    ...
    process_name: Optional[str] = Field(
        None, description="Name of the process (optional)"
    )
...
class MCPTools:
    ...
    async def process_control(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            if request.action == "start":
                ...
                success = await self.circus_manager.restart_process(
    ...
    async def send_input(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Sending input to process {request.process_name}: {sanitized_input}"
            )
