...
def log_parser(mock_pattern_manager, mock_classifier):
    ...
    with patch('src.log_parser.parser.PatternManager', return_value=mock_pattern_manager), \
...
class TestLogParserBasic:
    ...
    async def test_parse_log_line_error_handling(self, log_parser):
        ...
        log_parser.classifier.classify_log_entry.side_effect = Exception("Classification error")
...
class TestLogParserFiltering:
    ...
    def test_filter_logs_by_level(self, log_parser):
        ...
        log_entries = [
            {"level": "INFO", "message": "Info message", "timestamp": "2024-01-01T10:00:00"},
            {"level": "ERROR", "message": "Error message", "timestamp": "2024-01-01T10:00:01"},
            {"level": "DEBUG", "message": "Debug message", "timestamp": "2024-01-01T10:00:02"},
        ]
    ...
    def test_filter_logs_by_time_range(self, log_parser):
        ...
        log_entries = [
            ...
            {"timestamp": (base_time + timedelta(minutes=5)).isoformat(), "message": "Message 2"},
            {"timestamp": (base_time + timedelta(minutes=10)).isoformat(), "message": "Message 3"},
        ]
...
class TestLogParserStatistics:
    ...
    def test_get_log_summary(self, log_parser):
        ...
        log_entries = [
            {"level": "INFO", "process_name": "webapp1", "timestamp": "2024-01-01T10:00:00"},
            {"level": "ERROR", "process_name": "webapp1", "timestamp": "2024-01-01T10:00:01"},
            {"level": "INFO", "process_name": "webapp2", "timestamp": "2024-01-01T10:00:02"},
        ]
